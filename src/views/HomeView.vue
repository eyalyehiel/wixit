<template>
    <main class="home-view">
        <section class="hero">
            ...
            <h3>Discover the platform that gives you the freedom to create, design, manage and develop your web presence
                exactly the way you want</h3>
        ...
        <section class="website-template">
            <h1>Website templates that set
                you up for success</h1>
            <h4>Get a headstart on your journey with 900+ free, customizable website templates, strategically
                researched and tailored for every industry — or start from a blank canvas on our website builder.</h4>
            <button>Get Started</button>
            <!-- carrousel -->
        </section>
    </main>
